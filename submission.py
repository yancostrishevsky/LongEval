...
def generate_run(snapshot, index_dir, output_dir):
...
def main(dataset_id, output_dir, index_dir):
    ...
    for snapshot in snapshots:
        generate_run(snapshot, index_dir / snapshot.get_snapshot(), output_dir / snapshot.get_snapshot())

    shutil.copy('ir-metadata.yml', output_dir / 'ir-metadata.yml')
...
if __name__ == '__main__':
    ...
    def run(dataset, output, index):
        ...
        main(dataset, Path(output), Path(index))
