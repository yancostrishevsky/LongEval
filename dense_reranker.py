...
for _, row in retrieval_df.iterrows():
    ...
    if docid in document_texts:
        pairs.append((queries[queries['qid'] == qid]['query'].values[0], document_texts[docid]))
        pairs_metadata.append((qid, docid))

scores = model.predict(pairs, batch_size=32)

# Step 5: Build reranked DataFrame
