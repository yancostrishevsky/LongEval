...
document_embeddings = torch.tensor(np.load(SAVE_EMBEDDINGS_PATH))
...
qrels['docid'] = qrels['docid'].astype(str)  # KONIECZNIE
...
results_df.to_csv('dense_retrieval_longeval2025_filtered_results.csv', index=False)
